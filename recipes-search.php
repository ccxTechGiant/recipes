...
<style>
	.single_recepie:hover {
		...
		box-shadow: 0px 0px 10px 8px rgba(0, 0, 51, 0.5);
		padding: 10px;
	}
	</style>
    <!-- recepie_area_start  -->
            ...
            <div class="row">
				<?php
					...
					$searchTerm = $_GET['search'];	
						$query ="SELECT recipes.ID,recipes.food_name,recipes.about,recipes.Duration,recipes.Nick,recipes.Image FROM recipes JOIN designers ON designers.Phone = recipes.Phone WHERE designers.Phone = recipes.Phone AND recipes.food_name LIKE :searchTerm ORDER BY recipes.CreationDate DESC LIMIT :limit OFFSET :offset";
				...
				<?php }	}
					...
					<div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single_recepie text-center" style="border-radius: 0">
                        <div class="recepie_thumb" style="border-radius:0px;width: 600px;height: 60%;border-radius: 0;">
                            <img src="img/search_states.gif" style="width:600px;height: 300px;">
                        </div>
                        <a href="./" class="line_btn">Go Back</a>
                    </div>
				</div>
